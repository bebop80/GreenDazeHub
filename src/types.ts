...
export interface Rehearsal { date: string; from: string; to: string; room: string; notes: string; }
export interface FutureRehearsal { id: string; date: string; from: string; to: string; room: string; payer?: string; }
