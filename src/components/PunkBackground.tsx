...
export const PunkBackground: React.FC<PunkBackgroundProps> = () => {
  return (
    <div 
      ...
      aria-hidden="true"
    >
      {/* Background Punk Rock Collage Image - Edge to Edge */}
      <img
        src={punkBgImage}
        alt="Green Daze Punk Atmosphere"
        referrerPolicy="no-referrer"
        className="absolute inset-0 w-full h-full object-cover object-center opacity-[0.32] sm:opacity-[0.40] dark:opacity-[0.45] dark:sm:opacity-[0.58] filter contrast-125 brightness-95 dark:brightness-105 grayscale-[10%] dark:grayscale-0 mix-blend-multiply dark:mix-blend-lighten"
      />
